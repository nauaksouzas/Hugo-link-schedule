...
export const copy = {
  en: {
    ...
    "hero.lead": "A premium custom booking experience for Hugo Barber. Choose your service, select a date and time, and secure your spot directly in Hugo's calendar.",
    ...
    "card.kicker": "Booking engine", "card.title": "Schedule Directly", "card.divider": "custom flow", "card.notice": "Select a time below or click Start Booking. Your slot is guaranteed in Hugo's Google Calendar immediately.",
    "preview.step1": "Step 1", "preview.service": "Choose service", "preview.step2": "Step 2", "preview.details": "Select date/time & details", "preview.step3": "Step 3", "preview.google": "Instant confirmation",
    "about.kicker": "Since 2011", "about.title": "A sharper booking experience for a sharper cut.", "about.body": "Hugo works directly with each client from Goat Barbershop in Framingham. This software checks Hugo's calendar busy periods and records your booking instantly, without redirects or middlemen.",
    "services.kicker": "Services", "services.title": "Available in the booking flow", "services.body": "The public page shows the service menu without prices. Prices and durations appear inside the custom booking experience.",
    "flow.kicker": "How it works", "flow.title": "Check availability, secure your spot.", "flow.one": "Select your barbery service and any optional add-ons.", "flow.two": "Pick an available date and a 15-minute slot direct from Hugo's Google Calendar.", "flow.three": "Confirm your appointment! The program books his calendar instantly and shows a receipt.",
    ...
    "modal.kicker": "Secure Scheduling", "modal.title": "Schedule appointment", "modal.subtitle": "Choose your service first, then choose a day/time, then fill your details and confirm.", "modal.services": "1. Choose service",
    ...
    "google.button": "Confirm Appointment", "none": "None", "wash": "Wash & dry", "optional": "optional", "mins": "min", "selectService": "Please choose a service first.",
  ...
  pt: {
    ...
    "hero.lead": "Uma experiência de agendamento premium para Hugo Barber. Escolha seu serviço, selecione a data e o horário e garanta sua vaga direto no calendário do Hugo.",
    ...
    "card.kicker": "Sistema de agendamento", "card.title": "Agende Diretamente", "card.divider": "fluxo customizado", "card.notice": "Selecione um horário ou clique em Começar Agendamento. Sua vaga já entra no Google Calendar do Hugo instantaneamente.",
    "preview.step1": "Etapa 1", "preview.service": "Escolher serviço", "preview.step2": "Etapa 2", "preview.details": "Selecione data/hora e dados", "preview.step3": "Etapa 3", "preview.google": "Confirmação na hora",
    "about.kicker": "Desde 2011", "about.title": "Uma experiência de agendamento mais afiada para um corte mais afiado.", "about.body": "Hugo atende diretamente cada cliente no Goat Barbershop em Framingham. Este sistema verifica os horários ocupados no calendário do Hugo e registra sua vaga direto, sem intermediários.",
    "services.kicker": "Serviços", "services.title": "Disponíveis no agendamento", "services.body": "A página pública mostra o menu de serviços sem preços. Valores e durações aparecem dentro da experiência customizada de agendamento.",
    "flow.kicker": "Como funciona", "flow.title": "Verifique os horários e garanta sua vaga.", "flow.one": "Selecione o seu serviço e se deseja lavagem opcional.", "flow.two": "Escolha um dia e um horário de 15 minutos livre direto do Google Calendar do Hugo.", "flow.three": "Confirme o agendamento! O sistema envia e reserva seu horário direto no calendário dele.",
    "location.kicker": "Localização", "location.map": "Abrir no Google Maps", "hours.title": "Horários", "hours.week": "Segunda a sábado", "hours.sunday": "Domingo", "hours.closed": "Fechado", "hours.note": "Clientes podem agendar com início até as 6:00 PM. Horários nobres esgotam rapidamente.",
    "modal.kicker": "Agendamento Seguro", "modal.title": "Reservar horário", "modal.subtitle": "Escolha o serviço, selecione o dia/horário ideal, preencha seus dados e confirme seu agendamento.", "modal.services": "1. Escolher serviço",
    ...
    "google.button": "Confirmar Agendamento", "none": "Nenhum", "wash": "Lavagem e secagem", "optional": "opcional", "mins": "min", "selectService": "Por favor, escolha um serviço primeiro.",
